---
title: 'DeepSpecN: Revolutionizing Leaf Nitrogen Estimation Without Field Data'
subtitle: 'Simulation-based deep learning achieves breakthrough in hyperspectral plant phenotyping'
summary: 'DeepSpecN combines PROSPECT-PRO simulations with Conv-Transformer models to estimate leaf nitrogen content from hyperspectral reflectance, eliminating the need for field data collection while achieving unprecedented accuracy.'
authors:
- admin
...
image:
  filename: 'images/yang_25pp_gr2.jpg'
  caption: 'DeepSpecN model architecture for leaf nitrogen estimation'
  focal_point: 'Smart'
  preview_only: false
...
Congratulations to [**Shuai Yang**](/author/shuai-yang/) PhD student at TUM Precision Agriculture Lab and all collaborators for this remarkable achievement! 
...
🔗 **DOI**: [10.1016/j.plaphe.2025.100125](https://doi.org/10.1016/j.plaphe.2025.100125)
